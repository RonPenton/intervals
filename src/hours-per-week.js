...
const midpoints = training_definitions_1.CogganPowerZones
...
let upperBound = (0, training_1.computeMinutesForTrainingLoad)(midpoints[0], targetTSS);
let lowerBound = (0, training_1.computeMinutesForTrainingLoad)(midpoints[6], targetTSS);
...
while (true) {
    ...
    const mix = zoneMixRatios.map((ratio, i) => {
        ...
        const tss = (0, training_1.computeTrainingLoad)(minutes / 60, midpoints[i], 100);
